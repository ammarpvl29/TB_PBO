...
public class WelcomePanel extends SistakaPanel {
    ...
    public WelcomePanel(HomeGUI homeGUI) {
        ...
        JLabel welcomeLabel = new JLabel(homeGUI.judulHTML("Mini Tel - U Lib!"));
        JLabel wordsLabel = new JLabel(
                "<html><p align='center'>We live in a digital age and thrive on personal <br> connectivity. This is reflected in the availability <br> of our information resources.</p></html>");
        JLabel copyrightsLabel = new JLabel("Femboy Lovers @2023");
