...
import assignments.assignment4.frontend.anggota.ui.DetailUserPanel;
import assignments.assignment4.frontend.anggota.ui.PembayaranPanel;
...
import assignments.assignment4.frontend.staf.ui.TambahDosenPanel;
import assignments.assignment4.frontend.staf.ui.TambahKategoriPanel;
import assignments.assignment4.frontend.staf.ui.TambahMahasiswaPanel;

// Sebuah class seperti blueprint GUI
public class HomeGUI {
    ...
    // Method untuk melakukan inisiasi panel pada program
    ...
    public String judulHTML(String judul) {
        return "<html><b><p style='font-size:20px; color:#004C99; padding:5px; text-align:center'>" + judul
                + "</p></b></html>";
    }

    // Style Notes
    public String notesHTML(String judul) {
        return "<html><p style='font-size:8px; color:#A0A0A0; padding:5px'>" + judul + "</p></html>";
    }

    // Style Main Button
    public String mainButtonHTML(String judul) {
        return "<html><b><p style='color:#004C99;'>" + judul + "</p></b></html>";
    }

    // Style Kembali Button
    public String kembaliButtonHTML(String judul) {
        return "<html><p style='color:#990000;'>" + judul + "</p></html>";
    }
}
